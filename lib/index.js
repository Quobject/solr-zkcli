...
var get = function (options) {
  var debug = require('debug')('solr-zkcli:lib/index.js get');
...
var list = function (options) {
  var debug = require('debug')('solr-zkcli:lib/index.js list');
...
var clear = function (options) {
  var debug = require('debug')('solr-zkcli:lib/index.js clear');
...
var getfile = function (options) {
  var debug = require('debug')('solr-zkcli:lib/index.js getfile');
...
var downconfig = function (options) {
  var debug = require('debug')('solr-zkcli:lib/index.js downconfig');
